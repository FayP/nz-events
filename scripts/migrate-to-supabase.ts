      ...
      try {
        ...
        await supabasePrisma.event.create({
          data: {
            ...
            distances: event.distances ? (event.distances as any) : null,
            price: event.price ? (event.price as any) : null,
            images: event.images ? (event.images as any) : null,
            ...
            tags: event.tags,
            indexedInElasticsearch: event.indexedInElasticsearch,
            ...
            content: event.content
              ? {
                  create: {
                    id: event.content.id,
                    content: event.content.content as any,
